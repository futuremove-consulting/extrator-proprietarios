"""Agente Fisgar para extração de proprietários."""
...
class AgenteFisgar:
    """Agente para extração de proprietários do sistema Fisgar."""
    ...
    def processar_linha_tabela(self, linha: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """Processa uma linha da tabela do Fisgar e retorna registro estruturado."""
        ...
        registro = {
            ...
            'dom_reference': linha.get('dom_reference')  # Referência DOM para CTA
        }
    ...
    def salvar_checkpoint_com_scroll(self, scroll_position: Optional[int] = None) -> None:
        """Salva checkpoint incluindo posição de scroll."""
